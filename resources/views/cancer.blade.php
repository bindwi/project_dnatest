        ...
        <main>
            <div class="container mx-auto flex flex-col md:flex-row p-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <p class="mb-4">Your genetics determine up to 20% of your disease risk – but your lifestyle does the rest. Get screened and learn your risks so you can take effective action to live your healthiest life.</p>
                    <p>Detailed, personalised reports that help you determine:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Your risk level for 115+ cancers, serious diseases, and degenerative brain disorders</li>
                    </ul>
                ...
                <div class="md:w-1/2 flex flex-col items-center justify-center">
                    <img src="/img/cancer-cell.png" alt="DNA Test" class="mb-3 rounded-lg shadow-lg">
