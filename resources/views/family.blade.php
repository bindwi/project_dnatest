        ...
        <main>
            <div class="container mx-auto flex flex-col md:flex-row p-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <p class="mb-4">Your future child’s health starts with you. Get screened at home and gain valuable insights to help you make decisions that drastically improve the quality of your future family’s life.</p>
                    <p>Detailed, personalised reports that help you determine:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Your carrier risk for 160+ serious genetic diseases, including Cystic Fibrosis, Sickle Cell Disease, and more</li>
                    </ul>
                    <p>Plus, 500+ more reports including:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Beauty & well-being insights</li>
                ...
                <div class="md:w-1/2 flex flex-col items-center justify-center">
                    <img src="/img/family.png" alt="DNA Test" class="mb-3 rounded-lg shadow-lg">
