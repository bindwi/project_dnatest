        ...
        <main>
            <div class="container mx-auto flex flex-col md:flex-row p-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <p class="mb-4">Did you know? Up to 80% of your physique is determined by your genetics. Learn how to work with your DNA to build a diet and fitness routine that gets results more quickly and efficiently than ever before.</p>
                    <p>Detailed, personalised reports that help you determine:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>What sports & fitness routines are best suited to you</li>
                        <li>How to eat according to your body’s true needs</li>
                        <li>What supplements you need to support optimal health</li>
                    </ul>
                    <p>Plus, 500+ more reports including:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Convenient at-home saliva collection with free pick-up</li>
                        <li>Complimentary 30-minute genetic consultation included</li>
                    </ul>
                </div>
                <!-- Right Section -->
                <div class="md:w-1/2 flex flex-col items-center justify-center">
                    <img src="/img/bmi.png" alt="DNA Test" class="mb-4 rounded-lg shadow-lg">
