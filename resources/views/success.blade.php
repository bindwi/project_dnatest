        ...
        <main>
            <div class="container mx-auto flex flex-col md:flex-row p-8">
                ...
                <div class="md:w-1/2 flex flex-col justify-center">
                    ...
                    <p class="mb-4">Every parent hopes to nurture their child to success – but knowing how is another matter. Discover your child’s hidden genetic talents and help them achieve their highest potential.</p>
                    <p>Detailed, personalised reports that help you determine:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Your child’s predisposition to academic achievement, entrepreneurship, mathematic talent, and more</li>
                    </ul>
                    <p>Plus, 500+ more reports including:</p>
                    <ul class="list-disc list-inside mb-4">
                        <li>Their optimal diet & sports routines</li>
                        <li>Ancestry breakdown/li>
                        <li>Their risk level of inherited cancers & disease</li>
                ...
                <div class="md:w-1/2 flex flex-col items-center justify-center">
                    <img src="/img/success.png" alt="DNA Test" class="mb-3 rounded-lg shadow-lg">
